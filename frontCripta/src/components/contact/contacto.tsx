              ...
              {REDES_MOCK.map((red: RedSocial) => (
                <li key={red.id}>
                  <a
                    ...
                    style={{ "--red-color": red.color } as CSSProperties}
                  >
                    <span className="ct-red-icon">{ICON_MAP[red.icon]}</span>
                    <span className="ct-red-info">
                      <span className="ct-red-nombre">{red.nombre}</span>
                      <span className="ct-red-handle">{red.handle}</span>
                    </span>
                    <span className="ct-red-arrow">›</span>
                  </a>
                </li>
              ))}
            </ul>
